...
public class PlayerEntersIntoRoadBorderEvent extends Event {
    ...
    public PlayerEntersIntoRoadBorderEvent(Player player, ChunkCoord to, ChunkCoord from, Road enteredRoad) {
